...
3. The _Holman and Wiegert (1991)_ formula is an empirical one; this program treats it as a generally applicable model
...
6. The bounds used to truncate the various distributions during sampling are treated as fixed and abrupt rather than gradual
